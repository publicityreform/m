...
var key = 'pk.eyJ1IjoibGZpc2NoYmVjayIsImEiOiJjajZ4YjM3MjExZG9zMzN0YnRucWhsdnBkIn0.JiaeFUIn_pPSI4Mj2CNftw'
var white;
var orange;
...
function draw(){
  ...
  for (var i=0; i<len; i++) {
    meteorites.addMeteorite(vehicles.items[i].latitude, vehicles.items[i].longitude, vehicles.items[i].seconds_since_report);
    currentMeteorite++;
  }
}
